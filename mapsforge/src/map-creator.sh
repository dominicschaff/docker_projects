...
[ $GRAPHHOPPER_FILE ] || GRAPHHOPPER_FILE="/mapsforge/graphhopper.jar"
[ $GRAPHHOPPER_CONFIG ] || GRAPHHOPPER_CONFIG="/mapsforge/config.yml"
...
if [ "$MAP_CREATION" = "true" ]; then
  ...
  CMD="osmosis --rb file=$WORK_PATH/$NAME-latest.osm.pbf \
